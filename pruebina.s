...
FA_PRINT    MOVE.L D2,D0				
			...
			MOVE.W #$2000,SR			**CODIGO DE FALLO
			MOVE.W D1,SR
            BRA	PRINTFIN       	        	
...
PRINT_B    	MOVE.B (A1)+,D1            	 * parametro de entrada de ESCCAR (caracter a escribir)
            ...
            BEQ FB_PRINT				 * si no son iguales salto a FB_PRINT      
            ADD.L #1,D2                  * incrementamos contador.
            CMP.L D2,D4                  * comparamos contador con tama�o.
...
FB_PRINT   	MOVE.L D2,D0				 * D0 = numero de caracteres escritos(contador)
			CMP.L #0,D2          		 * comparamos la variable D2 con 0.
            BEQ PRINTFIN        	     * si D2 es 0 salto a FIN_PRINT
			MOVE.W SR,D1				**CODIGO DE OLAF
			MOVE.W #$2700,SR
            BSET #4,COPIA_IMR           	    * activamos las interrupciones por linea A             
            MOVE.B COPIA_IMR,IMR               * modificamos registro IMR
			MOVE.W #$2000,SR			**CODIGO DE OLAF
			MOVE.W D1,SR
			JMP	PRINTFIN        	     * salto a fin				
